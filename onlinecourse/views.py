...
# EXTRACT ANSWERS VIEW
# to collect the selected choices from the exam form from the request object
...
# EXAM RESULT VIEW 
# To check if learner passed exam and show their question results and correct result for each question
# Logic:
